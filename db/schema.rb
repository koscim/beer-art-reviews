...
ActiveRecord::Schema.define(version: 20170908195929) do
  ...
  create_table "art_labels", force: :cascade do |t|
    ...
    t.string "container_type", default: ""
    t.text "beer_description", default: ""
    t.text "art_description", default: ""
